...
void example_ckks_basics()
{
    ...
    cout << "Polynomial: " << sharpened_result.size() << endl;

    x1_encrypted = sharpened_result;
    // exit(1);

    // Plaintext x_final_plain;
    // decryptor.decrypt(sharpened_result, x_final_plain);
    // vector<double> result;
    // encoder.decode(x_final_plain, result);

    // // cout << "Example Pixel [Center]: " << output[channel_pixels + 16 * 32 + 16] << endl;
    ...
    cout << "Degree (N): " << poly_modulus_degree_val << endl;
    cout << "Modulus: " << coeff_modulus_size_val << endl;
    cout << "Polynomial: " << x1_encrypted.size() << endl;
    ...
    //Flip each coefficient of each polynomial
